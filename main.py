        ...
        def _invia():
            ...
            def _lavoro():
                lista_ghost = [
                    {
                        "icao": a.get("icao", ""),
                        "callsign": a.get("callsign", "").strip() or a.get("icao", ""),
                        "altitudine": a.get("altitudine", ""),
                    }
                    for a in _aerei_nel_raggio()
                ]
                with _opensky_lock:
                    lista_mainstream = [
                        {
                            "icao": a.get("icao", ""),
                            "callsign": (a.get("callsign") or a.get("icao", "")).strip(),
                            "altitudine": a.get("altitudine", ""),
                        }
                        for a in _opensky_aerei
                    ]
