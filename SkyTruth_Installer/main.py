...
SENZA registrare nulla. Il posizionamento preciso viene corretto
dall'esterno (da main.py, tramite il PID di questo processo).
Uso: webcam_viewer.py <indice_webcam> <titolo>
"""
import sys
import os
